...
```
tylapcheong@htb[/htb]$ tree splunk_shell/
...
```
tylapcheong@htb[/htb]$ cat inputs.conf 
...
```
        shellsession
tylapcheong@htb[/htb]$ tar -cvzf updater.tar.gz splunk_shell/
...
```
tylapcheong@htb[/htb]$ sudo nc -lnvp 443
